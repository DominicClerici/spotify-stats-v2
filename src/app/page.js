    ...
    <main>
      ...
      <section className="grid grid-cols-3 gap-8 max-w-[1200px] mx-auto">
        ...
        <div className={className.panel}>
          ...
          <p className={className.body}>
            Spotify stats allows you to share your stats with your friends. You
            can create a playlist of your top tracks, or create a poster image
            of your top artists and songs. Share your stats with your friends,
            or don't, you never know what songs are going to be at the top.
          </p>
        </div>
      </section>
    </main>
