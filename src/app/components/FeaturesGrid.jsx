...
const FeaturesGrid = () => {
  return (
    <section className="w-full">
      <div className="mx-auto grid max-w-[1000px] px-2 sm:px-4 lg:px-8">
        <div className="relative grid grid-cols-1 gap-x-16 gap-y-8 md:grid-cols-2">
          <div className="flex items-center gap-4">
            <div className="glow-below rounded-md bg-highlight/25 sm:rounded-xl">
              <svg
          ...
          <div className="glow-left flex items-center gap-4">
            <div className="rounded-md bg-highlight/25 sm:rounded-xl">
              <svg
                className="h-12 w-12 p-2 text-highlight sm:h-16 sm:w-16 sm:p-4"
                stroke="currentColor"
